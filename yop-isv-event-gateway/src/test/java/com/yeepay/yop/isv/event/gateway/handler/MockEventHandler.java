 ...
 */
@Component
public class MockEventHandler extends YopBaseEventHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(MockEventHandler.class);

    @Override
    public String getEventType() {
        return "yop.opr.payment";
    }

    @Override
    public YopEventResult handle(YopEvent event) throws YopHandleException {
        LOGGER.debug("mock event handle:{}", event);
        // TODO 这里是业务处理
