...
@ConditionalOnProperty(name = "yop.certs.locator", matchIfMissing = true, havingValue = "file")
@AutoConfigureAfter(GatewayAutoConfiguration.class)
public class ConfigFileCertsConfiguration {

    @Bean
    public EventRequestResolver eventRequestResolver(@Qualifier("configFileCertLocator") CertLocator certLocator) {
    ...
    @Bean
    public NotifyRequestResolver notifyRequestResolver(@Qualifier("configFileCertLocator") CertLocator certLocator,
