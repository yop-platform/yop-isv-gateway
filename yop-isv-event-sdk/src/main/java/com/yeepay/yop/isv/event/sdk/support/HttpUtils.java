    ...
    public static String getBodyString(HttpServletRequest req) throws IOException {
        ...
        if (StringUtils.isNotBlank(contentType) &&
            ...
            while (pars.hasMoreElements()) {
                name = pars.nextElement();
                bodyString.append(name).append("=").append(req.getParameter(name)).append("&");
            }
            return bodyString.length() > 0 ? bodyString.substring(0, bodyString.length() - 1) : bodyString.toString();
        }
