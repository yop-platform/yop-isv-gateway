package com.yeepay.yop.isv.gateway.servlet;
...
import static com.yeepay.yop.isv.gateway.servlet.YopCallbackServlet.CALLBACK_PREFIX;
 ...
 */
@WebServlet(urlPatterns = CALLBACK_PREFIX + "/*")
