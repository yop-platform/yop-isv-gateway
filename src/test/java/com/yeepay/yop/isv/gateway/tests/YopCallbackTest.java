...
public class YopCallbackTest extends WebApplicationTest {
    ...
    public void notifySm2Success() throws Exception {
        ...
        webClient.post().uri("/yop-callback/rest/v1.0/test/app-alias/create").contentType(MediaType.APPLICATION_JSON)
                ...
                .header("x-yop-encrypt", "yop-encrypt-v1/275568425014/SM4_CBC_PKCS5Padding/BEmuYglu6Y0M5jkqZN_yssw137rWIiaB0ToXJXsQytFDSwau5sMGnPKCnEe-2Bgg_ThowDqOdcGnsvzATS4ol4rk_fSPebBPMvnjyWZk5hpMYPJxCCEJ80MgHYE3pBt50LulUCaCYhYDyf4VO5rYyjQ/u3E2PbLDjeiZi9IeQm7xyA/stream//JA")
                .header("x-yop-request-id", "wuTest1652754804319")
                .header("x-yop-sign-serial-no", "275568425014")
